namespace Electric_billing_system
{
	...
	partial class Account_Settings : System.Windows.Forms.Form
	{
		...
		private PictureBox First_Name_pictureBox2;
		private PictureBox First_Name_pictureBox;
		...
		public Account_Settings(string id)
		{
			InitializeComponent();
			...
			c.Connection = conn;
			c.CommandText = $"SELECT FIRSTNAME,LASTNAME,USERNAME,USERPASSWORD,EMAIL,RECEIPT_NOTIFICATION,TWO_STEP FROM CUSTOMER WHERE CUSTOMERID='{Convert.ToInt32(id)}'";
		...
		{
			return First_Name_textbox.Text;
		}
